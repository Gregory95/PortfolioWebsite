                ...
                <div className="content-box">
                    ...
                    <div className='contact-right'>
                        <form ref={form} onSubmit={sendEmail}>
                            <input className="field" required={true} type="text" placeholder='Your name' name="name" />
                            <input className="field" required={true} type="email" placeholder='Your Email' name="_reply" />
